      ...
      <div>
        ...
        {onDelete && (
          <button
            ...
            className="text-white focus:outline-none focus:ring-0 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 my-2 bg-red-600 hover:bg-red-700 focus:ring-red-900"
          >
            Xoá
          </button>
        )}
