            ...
            <div className="flex flex-wrap justify-center mx-4 ">
                <div className="justify-center px-4">
                    ...
                    <h2
                        ...
                        "
                        >
                        LIÊN HỆ VỚI SHOPPING ZONE
                    </h2>
                    <p className="text-base text-body-color leading-relaxed mb-9">
                        Khi bạn có bất kỳ thắc mắc hay cần sự hỗ trợ, hãy liên hệ với Shopping Zone bằng cách dưới đây:
                    </p>
                    <div className="flex mb-8 w-full">
                        ...
                        <div className="w-full">
                            <h4 className="font-bold text-dark text-xl mb-1">Địa chỉ liên hệ</h4>
                    ...
                    <div className="flex mb-8 max-w-[370px] w-full">
                        ...
                        <div className="w-full">
                            <h4 className="font-bold text-dark text-xl mb-1">Hotline</h4>
                            <p className="text-base text-body-color">07979797979</p>
                        </div>
                    </div>
                    <div className="flex mb-8 max-w-[370px] w-full">
                        <div
                        ...
                        <div className="w-full">
                            ...
                            <p className="text-base text-body-color">shoppingzone@gmail.com</p>
                        </div>
                    </div>
                    </div>
                </div>
