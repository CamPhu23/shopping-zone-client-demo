        ...
        <div className="flex flex-wrap -mx-6 px-6">
          <div className="w-full px-5 sm:w-1/2 xl:w-1/3">
            <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
              ...
              <div className="mx-5">
                <h4 className="text-2xl font-semibold text-gray-700">{statisticData.totalAccounts}</h4>
            ...
            <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
              ...
              <div className="mx-5">
                <h4 className="text-2xl font-semibold text-gray-700">
                  {statisticData.totalReceipts}
                </h4>
                <div className="text-gray-500">Tổng số đơn đặt hàng</div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full mt-6 px-5 sm:w-1/2 xl:w-1/3 xl:mt-0">
            <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
              ...
              <div className="mx-5">
                <h4 className="text-2xl font-semibold text-gray-700">
                  {statisticData.totalProducts}
                </h4>
                <div className="text-gray-500">Tổng số sản phẩm</div>
              </div>
            </div>
          </div>
        </div>
