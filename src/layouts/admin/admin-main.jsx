    ...
    <div className="flex flex-row h-screen bg-slate-300">
      ...
      <div className="flex-1 h-full">
        <div className="p-8 flex flex-col h-screen">
          ...
          <div className="flex-1 mt-4 py-3 px-5 text-gray-700 bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700 overflow-y-scroll no-scrollbar">
            {component}
          </div>
        </div>
      </div>
